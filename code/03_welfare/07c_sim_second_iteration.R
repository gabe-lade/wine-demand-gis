# =============================================================================
# 07c_sim_second_iteration.R — port of Rscripts/price_share_simulation_second_iteration.R
...
# data/derived/welfare/simulated_price_share_second_iteration.csv
# =============================================================================
...
winedata <- read.csv(file.path(WF, "data_for_counterfactual_second_iteration.csv")) %>%
...
write.csv(winedata_sim, file.path(WF, "simulated_price_share_second_iteration.csv"))
cat("DONE sim2. non-converging:", paste(nonconverging_markets, collapse=","), "\n")

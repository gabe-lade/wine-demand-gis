...
*estimates demand model with double market size for roubstness check
********************************************************************************
set more off
clear all
set matsize 11000
...
gen market_size_double = 2*max_percapitacons*pop_above_20
...
esttab A_* using "Z:\NIELSENDATA\consumer_panel\codeSTATA\GianCarlo\Discrete Choice\Main\Results\table_B1.doc", replace /// 
	b(a2) ///
	nonumbers mtitles("Nested Logit Double Market Size") ///	title("\textsc{Demand Parameter Estimates}") ///
	se ///
	label ///
...
putexcel set "Z:\NIELSENDATA\consumer_panel\codeSTATA\GianCarlo\Discrete Choice\Main\Results\elasticities_table_B1 
...
save "Z:\NIELSENDATA\consumer_panel\codeSTATA\GianCarlo\Discrete Choice\Main\Elasticity Estimation\market size double\market_product_j.dta", replace
restore

rename product product_i
rename winetype winetype_i

joinby market using "Z:\NIELSENDATA\consumer_panel\codeSTATA\GianCarlo\Discrete Choice\Main\Elasticity Estimation\market size double\market_product_j.dta", unmatched(both)
capture drop _merge
